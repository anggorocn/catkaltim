...
<title>Aplikasi Assessment Center - Pemerintah Provinsi KALTIM</title>
...
<body leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0"<?php /*?> onLoad="setView();"<?php */?> class="bg-home">
                    	...
                    	<tr>
                            ...
                            <td>
                            	<div id="menu-2">
                                    ...
                                    <div id="menu-2-konten"><a href="#" data-flexmenu="master-satker">Master Satuan Kerja</a></div>
								...
								<ul id="master-soal" class="flexdropdownmenu" style="background-color:#385f0e;">
                                	<li><a href="monitoring.php?reqMode=tipe_soal" target="mainFullFrame" onClick="menuHandler('validator')">Tipe Soal</a></li>
                            		<?
                            		$tipe_ujian= new TipeUjian();
                            		$tipe_ujian->selectByParams(array(), -1, -1, " AND A.PARENT_ID = '0'");
                            		...
                            		<li><a href="#">Bank Soal</a>
                                        <ul>                                         
                                        	...
                                        	{
                                        		$tipeujianid= $tipe_ujian->getField("TIPE_UJIAN_ID");
                                        		$tipeujiannama= $tipe_ujian->getField("TIPE");
                                        		$tipeujiantreeid= $tipe_ujian->getField("ID");

                                        		$statementdetil= " AND SUBSTRING(A.ID, 1, 2) = '".$tipeujiantreeid."'";
                                        		$setdetil= new TipeUjian();
                                        		$jumlahdata= $setdetil->getCountByParamsBankSoal(array(), $statementdetil);
                                        		if($tipeujianid == 40)
                                        		{
                                        		...
                                        		$statementdetil= " AND A.ID = '".$tipeujiantreeid."'";
                                        		$setdetil= new TipeUjian();
                                        		$checkdata= $setdetil->getCountByParamsBankSoal(array(), $statementdetil);
                                        		// echo $setdetil->query;exit();
                                        		unset($setdetil);
                                        	...
                                        	?>
	                                        	...
	                                        	?>
	                                        	<li>
		                                        	<a href="#"><?=$tipeujiannama?></a>
		                                        	<ul>
		                                        		<?
		                                        		$statementdetil= " AND A.PARENT_ID = '".$tipeujiantreeid."'";
		                                        		$setdetil= new TipeUjian();
		                                        		$setdetil->selectByParamsBankSoal(array(), -1,-1, $statementdetil);
		                                        		while($setdetil->nextRow())
		                                        		{
		                                        			$tipeujianid= $setdetil->getField("TIPE_UJIAN_ID");
		                                        			$tipeujiannama= $setdetil->getField("TIPE_NAMA");
		                                        		?>
		                                        		<li><a href="monitoring.php?reqMode=bank_tipe_soal&reqTipe=<?=$tipeujianid?>" target="mainFullFrame" onClick="menuHandler('validator')"><?=$tipeujiannama?></a></li>
		                                        		<?
		                                        		}
		                                        		?>
		                                        	</ul>
								...
								<!-- MASTER PENILAIAN -->
                                <ul id="master-penilaian" class="flexdropdownmenu" style="background-color:#385f0e;">
                                	<li><a href="monitoring.php?reqMode=formula_assesment" target="mainFullFrame" onClick="menuHandler('validator')">Setting Pelaksanaan</a></li>
                                	<li><a href="monitoring.php?reqMode=jadwal_awal_tes" target="mainFullFrame" onClick="menuHandler('validator')">Setting Awal</a></li>
                                    <li><a href="monitoring.php?reqMode=jadwal" target="mainFullFrame" onClick="menuHandler('validator')">Jadwal</a></li>
                                    <li><a href="monitoring.php?reqMode=jadwal_multi_absen" target="mainFullFrame" onClick="menuHandler('validator')">Absen All</a></li>
                                    <li><a href="monitoring.php?reqMode=jadwal_absen" target="mainFullFrame" onClick="menuHandler('validator')">Absen Per Peserta</a></li>
                                    <!-- kemendagri reload -->
                                ...
                                <!-- MASTER DATA -->
                                <ul id="master-flex" class="flexdropdownmenu" style="background-color:#385f0e;">
                                	<li><a href="monitoring.php?reqMode=peraturan" target="mainFullFrame" onClick="menuHandler('validator')">Peraturan</a></li>
                                	<li><a href="monitoring.php?reqMode=atribut" target="mainFullFrame" onClick="menuHandler('validator')">Kamus Kompetensi</a></li>
                                    <li><a href="monitoring.php?reqMode=indikator_penilaian" target="mainFullFrame" onClick="menuHandler('validator')">Indikator Perilaku</a></li>
                                    <li><a href="monitoring.php?reqMode=training" target="mainFullFrame" onClick="menuHandler('validator')">Jenis Diklat</a></li>
                                    <!-- kemendagri reload -->
                                    <li><a href="monitoring.php?reqMode=asesor" target="mainFullFrame" onClick="menuHandler('validator')">Asesor</a></li>
                                    <li><a href="monitoring.php?reqMode=pejabat" target="mainFullFrame" onClick="menuHandler('validator')">Pejabat</a></li>
                                    <li><a href="monitoring.php?reqMode=penggalian" target="mainFullFrame" onClick="menuHandler('validator')">Alat Ukur</a></li>
                                    
                                	<li style="display:none"><a href="monitoring.php?reqMode=jabatan_atribut_potensi" target="mainFullFrame" onClick="menuHandler('validator')">Master Jabatan Atribut Potensi</a></li>
                                    <li style="display:none"><a href="monitoring.php?reqMode=jabatan_atribut_kompetensi" target="mainFullFrame" onClick="menuHandler('validator')">Master Jabatan Atribut Kompetensi</a></li>
                                    
                                </ul>

                                 <!-- MASTER SATKER -->
                                <ul id="master-satker" class="flexdropdownmenu" style="background-color:#385f0e;">
                                	<!-- <li><a href="monitoring.php?reqMode=satker_internal" target="mainFullFrame" onClick="menuHandler('validator')">Internal</a></li> -->
                                	<li><a href="monitoring.php?reqMode=satker_eksternal" target="mainFullFrame" onClick="menuHandler('validator')">Eksternal</a></li>
                                </ul>

...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",					  
		"sAjaxSource": "../json-pengaturan/jadwal_awal_tes_add_hapus_jadwal_json.php?reqId=<?=$reqId?>",
		...
		/* Click event handler */
		  ...
		  $('#btnCari').on('click', function () {
			  	var reqJadwalAwalTesSimulasiId= "";
			  	reqJadwalAwalTesSimulasiId= $("#reqJadwalAwalTesSimulasiId").val();
			  	oTable.fnReloadAjax("../json-pengaturan/jadwal_awal_tes_add_hapus_jadwal_json.php?reqId=<?=$reqId?>");
		  });
		  ...
		  $('#btnHapusData').on('click', function () {
			  	...
			  	$.messager.confirm('Konfirmasi',"Apakah anda yakin hapus, data terpilih?",function(r){
			  		if (r)
			  		{
			  			$.getJSON("../json-pengaturan/jadwal_awal_tes_add_hapus_jadwal_hapus.php?reqId=<?=$reqId?>&reqJadwalAwalTesSimulasiId="+reqJadwalAwalTesSimulasiId,
		  				function(data){
		  					setCariInfo();
        ...
        {
          // alert();
          reqDonaturLaysosId= String($("#reqJadwalAwalTesSimulasiId").val());
          ...
          //alert(reqCatatanVal);
          $("#reqJadwalAwalTesSimulasiId").val(reqPilihCheckVal);
...
<div id="content" style="height:auto; width:100%">
	<div id="header-tna-detil">Simulasi <span>Tanggal Hapus</span></div>
    ...
    <input type="hidden" id="reqJadwalAwalTesSimulasiId" name="reqJadwalAwalTesSimulasiId" />

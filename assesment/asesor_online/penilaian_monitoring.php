                                  ...
                                  <tbody>
                                    ...
                                    else
                                    {
                                      ...
                                      for($index_detil=0; $index_detil < count($arrayKey); $index_detil++)
                                      {
                                        ...
                                        // echo $reqJadwalPegawaiNamaIndikator;
                                        ...
                                        $infocari= $arrPegawaiNilai[$index_row]["PENGGALIAN_ATRIBUT"];
                                        $infojumlahpenggalianatribut= count(in_array_column($infocari, "PENGGALIAN_ATRIBUT", $arrPegawaiNilai));
                                      ...
                                      <tr>
                                          ...
                                          <div class="rbtn">
                                            <ul>
                                              <li style="width:100%; text-align:left" id="rbtn-<?=$index_detil?>-<?=$reqJadwalPegawaiIndikatorId?>-<?=$reqJadwalPegawaiLevelId?>-<?=$reqInfoPenggalianId?>-<?=$reqJadwalPegawaiDataAsesorId?>-<?=$tempAsesorId?>" class=" <?=$cssIndikator?>">
                                                ...
                                                <!-- <?="xxx".$reqJadwalPegawaiAtributIdLookUp."==".$reqJadwalPegawaiAtributId."&&".$indexTr."<=".$reqJadwalPegawaiJumlahLevel."??".$infojumlahpenggalianatribut."--".$infocari?> -->
                                              </li>
                                        <?
                                        }
                                        ?>
                                        ...
                                        if($reqJadwalPegawaiAtributIdLookUp == $reqJadwalPegawaiAtributId && $indexTr <= $infojumlahpenggalianatribut)
                                        {
                                        ?>
                                      ...
                                      if($indexTr == $infojumlahpenggalianatribut)
                                      {
                                        // reset info
                                        $indexTr= 1;
                                        $reqJadwalPegawaiAtributIdLookUp= "";
                              ...
                              <form id="ff-" method="post" novalidate>
                                ...
                                <table style="margin-bottom:60px;" class="profil">
                                  ...
                                  <tbody>
                                    ...
                                    // print_r($arrayKey);exit;
                                     // echo "ASdasda".count($arrayKey);exit;
                                    if($arrayKey == ''){}
                                    else
                                    {

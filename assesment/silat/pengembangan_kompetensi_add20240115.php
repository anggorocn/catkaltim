    				...
    				<tbody>
    					...
    					<tr >
    						...
    						<td>
			                    ...
			                    <input type="hidden" name="reqRumpunPengembanganAtributId[]" value="<?=$RumpunPengembanganinfoid?>" />
			                    <input type="hidden" name="reqRumpunPengembanganId[]" id="reqRumpunPengembanganId<?=$infoid?>" value="<?=$RumpunPengembanganinfopelatihanid?>" />
			                    <input type="hidden" name="reqRumpunPengembanganNama[]" id="reqRumpunPengembanganNama<?=$infoid?>" value="<?=$RumpunPengembanganinfopelatihannama?>" />
    						</td>
    						...
    						<td style="text-align: center;"><input type="text"  style=""  name="reqKeterangan[]" id="reqKeterangan<?=$infoid?>" <?=$disabled?>  value="<?=$infotahunnew?>" /></td>
    					</tr>
    					<?
 						// $sum=$sum+$infojp;       					
    					}

...
$reqKesenjanganKompetensi= httpFilterGet("reqKesenjanganKompetensi");
...
if(!empty($reqKesenjanganKompetensi))
{
	if($reqKesenjanganKompetensi == "1")
		$statement.= " AND A.IKK >= 50 ";
	else if($reqKesenjanganKompetensi == "2")
		$statement.= " AND A.IKK < 50 AND A.IKK >= 25 ";
	else if($reqKesenjanganKompetensi == "3")
		$statement.= " AND A.IKK < 25 AND A.IKK > 0 ";
	else if($reqKesenjanganKompetensi == "4")
		$statement.= " AND A.IKK <= 0 ";
}
...
$allRecord = $set->getCountByParamsRekapitulasi(array(), $statement);
if($_GET['sSearch'] == "")
	$allRecordFilter = $allRecord;
else
	$allRecordFilter = $set->getCountByParamsRekapitulasi(array(), $statement.$searchJson);
// echo $set->query;exit;
$sOrder="";
$set->selectByParamsRekapitulasi(array(), $dsplyRange, $dsplyStart, $statement.$searchJson, $sOrder);

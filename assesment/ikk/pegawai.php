...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready( function () {
		...
		"sScrollX": "100%",
		"sScrollXInner": "100%",
		"sAjaxSource": "../json-silat/pegawai_json.php?reqId=<?=$reqId?>&reqCari=<?=$reqCari?>",
		...
		/* Click event handler */
		  ...
		  $('#btnDetailData').on('click', function () {
			  ...
			  opUrl    = '../ikk/pegawai_edit.php?reqId='+anSelectedPegawaiId;
		  ...
		  $("#btnCari").on("click", function () {
		  	...
		  	oTable.fnReloadAjax("../json-silat/pegawai_json.php?reqStatusPeg="+reqStatusPeg+ "&reqId=<?=$reqId?>&sSearch="+reqPencarian);
		  });
...
<?
for($i=0; $i<count($setSatker); $i++){?>

	<script type="text/javascript">
		satkerFunc.push("<?=$setSatker[$i]?>");	
	</script>

<?}?>

<script type="text/javascript">
	function btnUpdateDataSimpeg(val)
	{
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <center><img src="../WEB/images/loading.gif">
    	<p id="myModalIsi">Some text in the Modal..</p></center>
  </div>

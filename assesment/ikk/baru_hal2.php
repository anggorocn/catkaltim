...
$set_catatan= new PenilaianRekomendasi();
$statement_catatan= " AND A.TIPE = 'uraian_kompetensi' AND A.PEGAWAI_ID = ".$reqId." AND A.JADWAL_TES_ID = ".$reqJadwalTesId;
$set_catatan->selectByParams(array(), -1,-1, $statement_catatan);
// echo $set_catatan->query;exit;
while($set_catatan->nextRow())
{
...
<body>
	<div class="container">
		...
		<table width="100%">
			<tr>
				<td width="5%"><strong>III.</strong></td>
				<td><strong>PROFIL KOMPETENSI</strong></td>
			</tr>
		</table>
		<table border="1" style="border-collapse: 1px solid black;text-align: center;font-size: 12px;width: 100%;" >
			<tr style="background: #febde6">
				<th style="padding:5px;width:5%" rowspan="2">NO</th>
				<th style="padding:5px;width:25%" rowspan="2">KOMPETENSI</th>
				<th style="padding:5px;width:5%" rowspan="2">LV</th>
				<th style="padding:5px;width:35%" colspan="6">RATING</th>
				<th style="padding:5px;width:30%" rowspan="2"> URAIAN KOMPETENSI</td>
            ...
            <?
			$tempGroupAspekId= $tempGroupParentAtributId= $cekawal="";
			...
			?>
                ...
                ?>
                    <tr>
                        ...
                        <?if($cekawal==''){
				                	$cekawal=1;?>
				                	<td rowspan="<?=$jumlah_atribut?>" class="left"><b>
				                		1.	Kekuatan</b><br>
															<p style="font-size: 10pt;text-align: justify;margin-bottom: 0px;">Berdasarkan hasil penilaian kompetensi yang dilakukan, maka yang menjadi kekuatannya adalah sebagai berikut:</p>
															<? 
															...
															<br>
															<br>
															<b>2.	Area Pengembangan</b><br>
															<p style=" font-size: 10pt;text-align: justify;margin-bottom: 0px;">Berdasarkan hasil penilaian kompetensi yang dilakukan, maka yang menjadi area pengembangannya adalah sebagai berikut:
                ...
                ?>
                    <tr>
                        ...
                        <!-- <td class="left" style=" text-align: justify"><?=$tempAtributKesimpulan?></td> -->
		...
		<!-- <table width="100%">
			<tr>
				...
				<td><strong>B. PROFIL KOMPETENSI</strong></td>
			</tr>
			<tr>
				<td width="5%"><strong></strong></td>
				<td>
			...
			<tr>
				<td width="5%"><strong></strong></td>
				<td  style="padding-bottom: 15px;font-size: 10pt;text-align: justify;"><?=$reqinfocatatan?></td>
			</tr>
			<?
			}
			?>
		...
		<table style=" width: 100%; margin: auto">
			<tr>
				<td style="text-align: justify;margin-bottom: 0px;">Berdasarkan profil dan uraian di atas, maka Saudara <?=$tempPegawaiNama?>  berada pada kategori : <?=$HasilKonversi?> 
				<!-- <tr>
					<td style="text-align: justify;">Rekomendasi yang disarankan :</td>	
				</tr> --> 
				<? 
				if ($jumlahPenilaianPotensiKesimpulan==0){?>
					<!-- <tr>
		...
		<table width="100%">
			<tr>
				<td width="5%"><strong>VI.</strong></td>
				<td><strong>SARAN PENEMPATAN</strong></td>
			</tr>
		</table>
		<table>
			<? 
			if ($jumlahPenilaianPotensiSaranPenempatan==0){?>
				<tr>
					<td style="text-align: justify;">-</td>	
				</tr>
			<?}
		...
		<table width="100%">
			<tr>
				<td width="5%"><strong>VII.</strong></td>
				<td><strong>SARAN PENGEMBANGAN</strong></td>
			</tr>
		</table>
		<table>
			<? 
			if ($jumlahPenilaianPotensiSaranPengembangan==0){?>
				<tr>
					<td style="text-align: justify;">-</td>	
				</tr>
			<?}

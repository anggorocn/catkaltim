...
<body>
	<div class="container">
		...
		<table style="font-size: 10pt; width: 100%; margin: auto">
			<tr>
				<td style="font-size: 14pt;">POSISI QUADRAN TALENT POOL SAAT INI  :</td>
			</tr>
			<?
			...
			<tr>
				<td style="font-size: 10pt; text-align: center;">
					Posisi kuadran : VIII  (Kinerja sesuai ekspetasi dan JPM Tinggi)
					<img src="<?=$talentkuadran?>" style="width: 100%">
				</td>
			</tr>
			<?
			}
			...
			<tr>
				<td style="font-size: 10pt; text-align: center;">
					...
					<img src="<?=$talentkompetensi?>" style="width: 120%">
				</td>
			</tr>
			<?
			}
			...
			<tr>
				<td style="font-size: 10pt; text-align: center;">
					...
					<img src="<?=$talentpotensi?>" style="width: 120%">
				</td>
			</tr>
			<?
			}
		...
		<!-- <p style="font-size: 14pt" ><strong>IV.	REKOMENDASI</strong></p>
		<p style="text-align: justify">Berdasarkan profil dan uraian di atas, maka Saudara <?=$tempPegawaiNama?>  berada pada kategori : <?=$HasilKonversi?> </p><br><?=$tempCatatanKesimpulan?></p>
		<p style="font-size: 14pt" ><strong>V.	SARAN PENEMPATAN</strong></p>
		<p style="text-align: justify"><?=$tempCatatanPenempatan?></p>

		<p style="font-size: 14pt" ><strong>VI.	SARAN PENGEMBANGAN</strong></p>
		<p style="text-align: justify"><?=$tempCatatanPengembangan?></p> -->
		<br>
		<br>

...
$allRecord = $set->getCountByParamsMonitoringPegawai(array(), $statement,$reqId);
if($reqCari == "")
	$allRecordFilter = $allRecord;
else
	$allRecordFilter = $set->getCountByParamsMonitoringPegawai(array(), $statement.$searchJson, $reqId);

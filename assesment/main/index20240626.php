...
$set= new Dashboard();
$set->selectByParamsSudahUjianNew(array(), -1, -1);
// echo $set->query; exit;
$set->firstRow();
...
$tempTotalEselonSudah="[934,684,486,273,44]";
                    ...
                    <div class="col-md-6" style="padding: 20px 5px;">
                        <div class="item" style="background-color:#0e7476; padding: 20px; border-radius: 20px;">
                           <!--  <form action="http://talenta-simace.kaltimbkd.info/admin" method="post" target="_blank">
                            ...
                            <a href="http://talenta-simace.kaltimbkd.info/admin?reqAdminId=1" style="text-align: center;">
                                <div class="icon" style="color: #f8f4c2;"><i class="fa fa-bar-chart fa-3x"></i></div>
                                <div class="teks" style="color: #f8f4c2; font-size: 12px;">Manajemen Talenta</div>
                            </a>
                        </div>
                            ...
                            <a href="#" style="background-color:#35d8ac; color: white;">
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="padding-right: 0;">
                                        <div style="font-family: 'Open Sans Bold'; font-size: 20px;text-align: right;"><?=$tempSudahUjian?></div>
                                        <br>
    ...
    <script type="text/javascript">
        Highcharts.chart('container', {
            ...
            xAxis: {
                ...
                categories: ['Pelaksana', 'Fungsional', 'Pengawas', 'Administrator', 'JPT'],
                crosshair: true,
                accessibility: {
                    description: 'Jenjang Jabatan'
                }
            },
            yAxis: {
                min: 0,

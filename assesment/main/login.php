...
<body style="background-color:#fffcf3">
	<div class="col-md-12 col-lg-4 desktop-login" style=""> 
		<img src="../WEB/images/kiri-login.png" style="width: 100%;">
	</div>
	<div class="col-md-12 mobile-login" style="display: none; margin-top: 20px;">
        <div class="row">
            <div class="col-lg-2 col-lg-12" style="text-align: center">
                <img src="../WEB/images/logo-judul.png"> 
            </div>
            <div class="col-lg-5 col-lg-12 judul" style="text-align: center;">

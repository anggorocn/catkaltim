...
<div class="row" style="background-color: white;margin: 5px 15px;border-radius: 20px;">
    <div class="col-lg-6">
                ...
                <tr>
                    ...
                    <!--     <select name="reqPegawaiPangkatId" id="reqPegawaiPangkatId">
                            ...
                            while($pangkat_new->nextRow())
                            {
                             ...
                             ?>
                             <option value="<?=$infoid?>" <? if($dataApiJabatan[0]['id_golongan'] == $infoid) echo 'selected'?>><?=$infonama?></option>
                             <?
                         }
                         ?> -->
                          <input type="text" value="<?=$dataApiJabatan[0]['golongan']?> (<?=$dataApiJabatan[0]['pangkat']?>)" style="width:100%" class="form-control easyui-validatebox" readonly />
                         <input type="hidden" name="reqPegawaiPangkatId" id="reqPegawaiPangkatId" <?=$read?> value="<?=$dataApiJabatan[0]['id_golongan']?>" style="width:50%" class="form-control easyui-validatebox" readonly />
                         </select>
                    </td>
                </tr>
                <tr>

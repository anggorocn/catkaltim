...
function setJudul($lang)
{
	if($lang == "en")
	{
		$arrayJudul["index"]["informasi_area"]= "Information";
		$arrayJudul["index"]["gantipassword"]= "Change Password";
		$arrayJudul["index"]["lupapassword"]= "Forgot Password";
		$arrayJudul["index"]["nama"]= "Name";
		
		$arrayJudul["index"]["beranda"]= "Home";
		$arrayJudul["index"]["syaratketentuan"]= "Terms and Conditions";
		$arrayJudul["index"]["informasi"]= "Information";
		$arrayJudul["index"]["mainmenu"]= "Main Menu";
		$arrayJudul["index"]["daftarlowongan"]= "List of Jobs";
		$arrayJudul["index"]["daftarlamarananda"]= "Your List Application";
		$arrayJudul["index"]["upload_dokumen"]= "Document Upload";
		$arrayJudul["index"]["download_dokumen"]= "Document Download";
		$arrayJudul["index"]["isianformulir"]= "Form Entry";
		
		$arrayJudul["index"]["data_pribadi"]= "Personal data";
		$arrayJudul["index"]["data_pendidikan_formal"]= "Formal Education Data";
		$arrayJudul["index"]["data_pelatihan"]= "Training Data";
		$arrayJudul["index"]["data_pengalaman"]= "Experience Data";
		$arrayJudul["index"]["data_sertifikat"]= "Certificate Data";
		$arrayJudul["index"]["data_keluarga"]= "Family Data";
		$arrayJudul["index"]["data_lampiran"]= "Attachment Data";
		$arrayJudul["index"]["data_peminatan"]= "Data Specialization";
		
		$arrayJudul["index"]["data_password"]= "Reset Password";
		
		$arrayJudul["index"]["kategorilowongan"]= "Job Category";
		$arrayJudul["index"]["cabanglowongan"]= "Branch";
		
		$arrayJudul["home"]["lowonganaktif"]= "Job Vacant Active";
		
		$arrayJudul["daftar_lowongan"]["daftarlowonganaktif"]= "List of Job Vacant Active";
		$arrayJudul["daftar_lowongan"]["info"]= "Make sure you have completed form field data! Please complete the file first";
		$arrayJudul["daftar_lowongan"]["kode"]= "Code";
		$arrayJudul["daftar_lowongan"]["jabatan"]= "Position";
		$arrayJudul["daftar_lowongan"]["batasakhir"]= "Deadline";
		$arrayJudul["daftar_lowongan"]["aksi"]= "action";
		$arrayJudul["daftar_lowongan"]["kirimlamaran"]= "Send Application";
		$arrayJudul["daftar_lowongan"]["sudahmendaftartanggal"]= "Already signed up date";
		
		$arrayJudul["daftar_lamaran"]["judul"]= "Your application";
		$arrayJudul["daftar_lamaran"]["kode"]= "Code";
		$arrayJudul["daftar_lamaran"]["jabatan"]= "Position";
		$arrayJudul["daftar_lamaran"]["tanggalkirim"]= "Date Posted";
		$arrayJudul["daftar_lamaran"]["aksi"]= "action";
		
		$arrayJudul["password"]["judul"]= "Forgot Password";
		$arrayJudul["password"]["info"]= "Forgot your password?";
		$arrayJudul["password"]["alert"]= "Do not worry, please send your email, we <em>will help</em> reset your email.";
	}
	else
	{
		$arrayJudul["index"]["data_koreksi_nip"]= "Koreksi Nip";
		$arrayJudul["koreksi_nip"]["judul"]= "Koreksi Nip";
		

		$arrayJudul["index"]["informasi_area"]= "Informasi";
		$arrayJudul["index"]["gantipassword"]= "Ganti Password";
		$arrayJudul["index"]["lupapassword"]= "Lupa Password";
		$arrayJudul["index"]["nama"]= "Nama";
		
		$arrayJudul["index"]["beranda"]= "Beranda";
		$arrayJudul["index"]["syaratketentuan"]= "Syarat dan Ketentuan";
		$arrayJudul["index"]["informasi"]= "Informasi";
		$arrayJudul["index"]["mainmenu"]= "Main Menu";
		// $arrayJudul["index"]["daftarlowongan"]= "Daftar Lowongan";
		// $arrayJudul["index"]["daftarlamarananda"]= "Daftar Lamaran Anda";

		$arrayJudul["index"]["daftarlowongan"]= "History Assesment";
		$arrayJudul["index"]["daftarlamarananda"]= "Assesment yang akan di ikuti";
		$arrayJudul["index"]["upload_dokumen"]= "Upload Dokumen";
		$arrayJudul["upload_dokumen"]["judul"]= "Upload Dokumen";

		$arrayJudul["index"]["download_dokumen"]= "Download Dokumen";
		$arrayJudul["download_dokumen"]["judul"]= "Download Dokumen";


		$arrayJudul["index"]["isianformulir"]= "Daftar Riwayat";
		
		$arrayJudul["index"]["data_pribadi"]= "Daftar Riwayat Hidup";
		$arrayJudul["index"]["data_pendidikan_formal"]= "Data Pendidikan Formal";
		$arrayJudul["index"]["data_pelatihan"]= "Data Pelatihan";
		$arrayJudul["index"]["data_pengalaman"]= "Data Pengalaman";
		$arrayJudul["index"]["data_sertifikat"]= "Data Sertifikat";
		$arrayJudul["index"]["data_keluarga"]= "Data Keluarga";
		$arrayJudul["index"]["data_lampiran"]= "Data Lampiran";
		$arrayJudul["index"]["data_peminatan"]= "Data Peminatan";
		
		$arrayJudul["index"]["data_password"]= "Ubah Password";
		
		$arrayJudul["index"]["kategorilowongan"]= "Kategori Lowongan";
		$arrayJudul["index"]["cabanglowongan"]= "Cabang";
		
		$arrayJudul["home"]["lowonganaktif"]= "Agenda Assesment";
		
		$arrayJudul["daftar_lowongan"]["daftarlowonganaktif"]= "History Assesment";
		$arrayJudul["daftar_lowongan"]["info"]= "Pastikan Anda telah melengkapi data isian formulir! silahkan lengkapi berkas terlebih dahulu";
		$arrayJudul["daftar_lowongan"]["kode"]= "Jenis Assesment";
		$arrayJudul["daftar_lowongan"]["jabatan"]= "Assesment";
		$arrayJudul["daftar_lowongan"]["batasakhir"]= "Tanggal";
		$arrayJudul["daftar_lowongan"]["aksi"]= "Lokasi";
		$arrayJudul["daftar_lowongan"]["kirimlamaran"]= "Kirim Lamaran";
		$arrayJudul["daftar_lowongan"]["sudahmendaftartanggal"]= "Sudah mendaftar tanggal";
		
		$arrayJudul["daftar_lamaran"]["judul"]= "Assesment yang akan di ikuti";
		$arrayJudul["daftar_lamaran"]["kode"]= "Jenis Diklat";
		$arrayJudul["daftar_lamaran"]["jabatan"]= "Assesment";
		$arrayJudul["daftar_lamaran"]["tanggalkirim"]= "Tanggal";
		$arrayJudul["daftar_lamaran"]["aksi"]= "Aksi";
		
		$arrayJudul["password"]["judul"]= "Lupa Password";
		$arrayJudul["password"]["info"]= "Lupa Password Anda?";
		$arrayJudul["password"]["alert"]= "Jangan khawatir, silakan kirimkan email Anda, kami akan membantu me-<em>reset</em> email Anda.";
